...
- [ ] T024 Executar `python3 .specify/scripts/skill-lint.py --skill madruga/qa` — confirmar 0 erros de lint; se falhar, corrigir o qa.md antes de avançar para Phase 4
