...
- [x] T028 Executar `python3 .specify/scripts/skill-lint.py --skill madruga/qa` — confirmar 0 erros; executar `make test` para verificar zero regressões em testes existentes
