...
| **Architecture Skills** | 4 skills (`madruga/*`): platform-new, architecture-portal, vision-one-pager, solution-overview. Geracao de artefatos de arquitetura. | Arquiteto-Operator | Artefatos gerados seguem template padrao |
