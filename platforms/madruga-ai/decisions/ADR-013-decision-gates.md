...
decision: We will classify all decisions as 1-way doors (irreversible, require human
  approval) or 2-way doors (reversible, auto-decidable by daemon), with configurable
...
We will classify all decisions as 1-way doors (irreversible, require human approval) or 2-way doors (reversible, auto-decidable by daemon), with configurable always_2way patterns and automatic ADR generation for 1-way doors.

## Alternativas consideradas

### Tudo escala para humano
- Pros: seguro, humano decide tudo.
- Cons: mata autonomia do daemon, pipeline para a cada decisao trivial, nao escala.
