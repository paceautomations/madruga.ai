...
## Contexto
Fulano gerencia credenciais sensiveis de multiplos tenants: tokens da Evolution API (WhatsApp), API keys de LLM providers, webhooks secrets, credenciais de integracoes externas. Agentes AI operam em real-time sem supervisao humana direta, amplificando o impacto de qualquer vazamento.
