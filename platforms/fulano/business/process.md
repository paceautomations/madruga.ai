...
sequenceDiagram
    ...
    M2->>Redis: Lua script atomico (buffer 3s)
    Note over M2,Redis: Agrupa mensagens rapidas<br/>do mesmo usuario.<br/>Evita processar cada msg<br/>individualmente.
    Redis-->>M2: BufferedBatch pronto (apos 3s)
...
sequenceDiagram
    ...
    participant DB as Supabase Fulano
...
sequenceDiagram
    ...
    participant Admin as fulano-admin
