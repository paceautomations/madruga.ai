...
## Contexto
ProsaUAI usa Pool model compartilhado (ADR-011) onde todos os tenants dividem a mesma infra: Postgres, Redis, Bifrost, LLM providers. Sem protecao, um unico tenant pode consumir todos os recursos (LLM tokens, Redis connections, CPU) e degradar a experiencia de todos os outros. Isso e o problema classico de "noisy neighbor" em sistemas multi-tenant.
