...
phase0_ack: "speckit.plan 2026-04-19 — adotado integralmente como research Phase 0"
---

# Epic 009 — Channel Ingestion Normalization + Content Processing

> **Nota Phase 0 (speckit.plan, 2026-04-19)**: este documento (preservado do `EPIC009_full_escope.md v2026-04-19` conforme pitch.md) é o output oficial de Phase 0 do plan skill. Todas as `NEEDS CLARIFICATION` estão resolvidas — veja §1 "Decisões travadas" (22 decisões) + `spec.md::Clarifications` (5 Q&As pós-clarify). Nenhuma decisão nova foi tomada nesta etapa: plan.md consome este research + spec + pitch + decisions.md inalterados. Artefatos Phase 1 (data-model.md, contracts/, quickstart.md) são novos e vivem ao lado.
