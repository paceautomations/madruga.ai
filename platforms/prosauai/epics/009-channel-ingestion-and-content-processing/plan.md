...
| 5 | PR-C coding + merge | ADR-035; `MetaCloudAdapter.normalize()` + auth HMAC; fixtures 4 reais; handler `/webhook/meta_cloud/`; diff zero em `pipeline.py`/`processors/`/`core/router/` (SC-013) | SC-013, SC-014 |
