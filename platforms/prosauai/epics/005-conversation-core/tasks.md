...
- [x] T063 Code review final: verificar que FALLBACK_MESSAGE é usado em todos os error paths, connection pool sizing alinhado ao semáforo (10), e timeout de 5s para pool esgotado
