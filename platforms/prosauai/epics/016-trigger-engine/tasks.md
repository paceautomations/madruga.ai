...
- [x] T905 Executar Journey J-001 (happy path) declarado em `testing/journeys.md` — todos os steps com assertions OK, incluindo trigger smoke (configurar trigger dry_run + verificar row em `trigger_events` apos 1 tick)
