...
- Redis debounce (Lua atomic, 3s window + jitter 0-1s anti-avalanche)
...
- **Redis Lua atomicity** → Usar EVAL com script unico, nao multiplos comandos separados. Adicionar jitter aleatorio (0-1s) no TTL do buffer para evitar avalanche de flushes simultaneos
