---
description: Break a project into Shape Up epics with Problem, Solution, Rabbit Holes, and Acceptance Criteria
arguments:
  - name: platform
...
Break the project into epics using Shape Up format: Problem, Solution, Rabbit Holes, No-gos, Acceptance Criteria. Each epic becomes `epics/NNN-slug/pitch.md`.
...
Product Manager (Shape Up) — problem before solution, scope as constraint. Write generated artifacts in Brazilian Portuguese (PT-BR).
...
| **Trade-offs** | "MVP with [2 epics] or full delivery with [5]?" |
...
| 2 | Is scope realistic for one epic? | Adjust or split |
...
| Total scope > 8 epics | Alert about scope risk |
