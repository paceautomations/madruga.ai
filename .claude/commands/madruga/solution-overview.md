...
Verificar se existe epics em `epics/` — se sim, ler para extrair features.
...
Se ja coletou contexto de docs existentes (vision, epics), apresentar resumo e perguntar se quer ajustar.
