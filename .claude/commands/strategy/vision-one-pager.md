...
Salvar em `services/vision/platforms/<nome>/0-vision-brief.md`. Criar diretorio se nao existir.
...
Em ambos os casos, verificar se ja existe arquivo em `services/vision/platforms/<nome>/0-vision-brief.md`. Se existir, ler como base.
...
| 8 | Frontmatter MkDocs correto (title + updated) | Corrigir |
...
1. Salvar em `services/vision/platforms/<nome>/0-vision-brief.md`
2. Informar ao usuario:

```
## Vision One-Pager gerado

**Arquivo:** services/vision/platforms/<nome>/0-vision-brief.md
**Linhas:** <N>
...
| Plataforma ja tem vision brief | Ler como base, perguntar se quer reescrever do zero ou iterar |
