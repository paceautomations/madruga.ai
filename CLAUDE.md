...
├── .claude/
│   ├── commands/madruga/      # Skills: platform-new, architecture-portal, vision, solution-overview
...
- **platform.yaml**: Declarative manifest defining available views, lifecycle stage, and build commands for each platform
